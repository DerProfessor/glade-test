...
parens p = text "(" ATerm.SimpPretty.<> p ATerm.SimpPretty.<> text ")"

braces :: SDoc -> SDoc -- ^ Wrap document in @{...}@
braces p = text "{" ATerm.SimpPretty.<> p ATerm.SimpPretty.<> text "}"

brackets :: SDoc -> SDoc -- ^ Wrap document in @[...]@
brackets p = text "[" ATerm.SimpPretty.<> p ATerm.SimpPretty.<> text "]"
